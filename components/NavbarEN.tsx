        ...
        <div className="flex justify-between items-center">
          ...
          <div className="flex items-center gap-4">
            <div className="hidden md:flex items-center gap-2 text-sm text-gray-500 dark:text-gray-400">
              <Link href="/" className="font-medium text-blue-600 dark:text-blue-400">EN</Link>
              <span className="text-gray-300">|</span>
              <Link href="/de" className="hover:text-blue-600 dark:hover:text-blue-400 transition-colors">DE</Link>
              <span className="text-gray-300">|</span>
              <Link href="/fr" className="hover:text-blue-600 dark:hover:text-blue-400 transition-colors">FR</Link>
            </div>
